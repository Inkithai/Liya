...
export default function CheckoutPage() {
 ...
 const { register, handleSubmit, watch, setValue, formState: { errors } } = useForm<FormValues>({ resolver: zodResolver(schema), defaultValues: { city: context.location ??"Kandy", deliveryDate: context.deliveryDate ?? tomorrow } });
 ...
 if (!cart.length) return toast.error("Add an item first to generate a message");
