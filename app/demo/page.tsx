...
export default function DemoEntryPage() {
 ...
 <section className="w-full max-w-lg rounded-[2rem] border border-foreground/5 bg-card/78 p-8 text-center shadow-2xl shadow-black/[0.06] backdrop-blur-2xl dark:bg-white/[0.06]">
 ...
 <p className="mt-3 text-foreground/60">Liya is preparing the judge path: story, live search, shelf, cart and checkout.</p><p className="mt-2 text-sm font-semibold text-liya-700 dark:text-liya-300">Unlike a product grid, Liya chooses and completes the gift flow with you.</p>
