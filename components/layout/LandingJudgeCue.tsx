...
export function LandingJudgeCue() {
  ...
  return <div className="mx-auto mt-6 max-w-7xl px-4">
    <div className="flex flex-col gap-3 rounded-[1.5rem] border border-black/5 bg-[hsl(var(--card))] p-4 shadow-lg shadow-black/[0.03] backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.05] sm:flex-row sm:items-center sm:justify-between">
