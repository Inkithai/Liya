...
export function ProductCard({ product, context, featured = false }: { product: Product; context: ShopperContext; featured?: boolean }) {
 ...
 <p title={`Why this gift: ${emotionalLine}`} className="mt-3 rounded-2xl bg-card/70 p-3 text-sm italic leading-5 text-foreground/65 dark:bg-foreground/10 dark:text-white/70">&quot;{emotionalLine}&quot;</p>
