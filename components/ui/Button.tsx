...
export const Button = forwardRef<HTMLButtonElement, Props>(({ className, variant = "primary", size = "md", ...props }, ref) => (
  <button
    ...
    className={cn(
      ...
      variant === "secondary" && "bg-[hsl(var(--card))] text-ink shadow-lg shadow-black/5 ring-1 ring-black/5 hover:bg-[hsl(var(--muted))] dark:bg-white/10 dark:text-white dark:ring-white/10",
