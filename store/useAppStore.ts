...
export const useAppStore = create<AppState>()(persist((set, get) => ({
  ...
  language: "en",
  context: { language: "en" },
  messages: [{ id: id(), role: "assistant", content: liyaGreeting("en"), createdAt: Date.now(), language: "en", chips: ["Run Demo Mode", "Gift finder", "Birthday under Rs. 8,000", "Trending", "Track order", "Reorder"] }],
  products: [],
  compareIds: [],
  wishlist: [],
  recentlyViewed: [],
  ...
  resetChat: () => set((state) => ({ context: { language: state.language }, products: [], memory: { preferences: [], dislikes: [], notes: [], emotionalIntent: "neutral", styleSignals: [] }, demoStartedAt: undefined, demoLocked: false, reliabilityMode: "live", messages: [{ id: id(), role: "assistant", content: liyaGreeting(state.language), createdAt: Date.now(), language: state.language, chips: ["Run Demo Mode", "Gift finder", "Smart bundle", "Trending"] }] })),
